...
# Development Setup (Note In order to run locally you must comment out the get/ post call to heroku in List.js and listview.js in favor of the local hosted backend).
